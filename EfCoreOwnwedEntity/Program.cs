...
namespace EfCoreOwnwedEntity
{
    class Program
    {
        public static string ConnectionString = "Data Source=.\\SQLExpress;Database=OwnedTest;MultipleActiveResultSets=true;Trusted_Connection=True";
        ...
        static async Task Main(string[] args)
        {
            ...
            /// Read updated company from db, expecting to see flags with false values - ERROR, entity has True values
